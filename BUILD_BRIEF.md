...
You are building the public face of **robertobendi/Any** (modeled after https://www.facebook.com/anyoatdisenyo). Target: GitHub
...
user can log into the local admin later):
    ...
    ADMIN_PASSWORD="bis-rFQ9vyOI8Y8Lsf" \
    ADMIN_NAME="Admin" \
    SITE_NAME="Any" \
